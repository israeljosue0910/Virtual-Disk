...
public class SimpleOperandHandler {
	...
	public static boolean isValidToken(String tType, String token) { 
		...
		if (tType.equals("disk_name")||tType.equals("disk_name")||
				tType.equals("file_name")||tType.equals("ext_file_name")||
				tType.equals("file_name_1")||tType.equals("file_name_2")||
				tType.equals("dir_name")||tType.equals("name")) 
			return isValidName(token); 
		else if (tType.equals("bsize")|| tType.equals("nblocks"))
			return isValidInt(token); 
		else if (tType.equals("return"))
			return isValidDot(token);
		else 
			return false; 
	...
	private static boolean isValidDot(String operand) { 
		if (operand.length() == 0) 
			return false; 
		if (operand.equals(".."))
			return true;
